...
Starte im Verzeichnis `build/git-uebungen/aufgaben/modularisierung-submodules/submodules`.
...
Starte im Verzeichnis `build/git-uebungen/aufgaben/modularisierung-submodules`.
